...
<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content mt-2">
        <ul class="navigation navigation-main mb-3" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            @canany(['read-sasaran-kinerjas', 'read-indikator-kinerja-kegiatans', 'read-target-realisasis','read-achievement-levels','read-cooperation-types', 'read-cooperation-fields', 'read-cooperations', 'read-partners', 'read-achievement-types', 'read-achievement-program-studis','read-achievements','read-document-types', 'read-documents','read-employees', 'read-employee-types', 'read-employee-statuses', 'read-employee-program-studis'])
            <li class="navigation-header">
                <span>Master Data</span>
            </li>
                @canany(['read-achievement-levels', 'read-achievement-types', 'read-achievement-program-studis','read-achievements'])
                    <li class="nav-item">
                        <a href="#"><i class="feather icon-award"></i><span class="menu-title"
                                ...
                                <li>
                                    <a href="{{ route('achievement-levels') }}" data-toggle="ajax">
                                        <i class="feather icon-circle"></i><span class="menu-item"
                                            data-i18n="Tingkat Prestasi">Tingkat Prestasi</span>
                                    </a>
                                </li>
                            @endcan
                            @can('read-achievement-program-studis')
                                <li>
                                    <a href="{{ route('achievement-program-studis') }}" data-toggle="ajax">
                                        <i class="feather icon-circle"></i><span class="menu-item"
                                            data-i18n="Tingkat Prestasi">Program Studi</span>
                                    </a>
                                </li>
                            @endcan
                            @can('read-achievements')
                                <li>
                                    <a href="{{ route('achievements') }}" data-toggle="ajax">
                                        <i class="feather icon-circle"></i><span class="menu-item"
                                            data-i18n="Daftar Prestasi">Prestasi</span>
                                    </a>
                                </li>
                            @endcan
                        </ul>
                        ...
                        <ul class="menu-content">
                            ...
                            @can('read-cooperation-types')
                                <li><a href="{{ route('cooperation-types') }}" data-toggle="ajax">
                                        <i class="feather icon-circle"></i><span class="menu-item"
                                            data-i18n="Jenis Kerjasama">Jenis
                                            Kerjasama</span></a>
                                </li>
                            @endcan
                ...
                @endcan
                @canany(['read-sasaran-kinerjas', 'read-indikator-kinerja-kegiatans', 'read-target-realisasis'])
                    <li class="nav-item has-sub">
                        <a href="#">
                            <i class="feather icon-layers"></i>
                            <span class="menu-title" data-i18n="IndikatorKinerjaUtama">Indikator Kinerja Utama</span>
                        </a>
                        <ul class="menu-content">
                            @can('read-sasaran-kinerjas')
                                <li>
                            ...
                            @endcan
                            @can('read-indikator-kinerja-kegiatans')
                                <li>
                                    <a data-toggle="ajax" href="indikator_kinerja_kegiatans">
                                        <i class="feather icon-bar-chart-2"></i>
                                        <span class="menu-item" data-i18n="IndikatorKegiatan">Indikator Kinerja Kegiatan</span>
                                    </a>
                                </li>
                            @endcan
                            @can('read-target-realisasis')
                                <li>
